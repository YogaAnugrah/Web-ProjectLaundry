...
$query = "SELECT transaksi.*,member.nama_member , detail_transaksi.total_harga FROM transaksi 
          INNER JOIN member ON member.id_member = transaksi.member_id INNER JOIN detail_transaksi 
          ON detail_transaksi.transaksi_id = transaksi.id_transaksi AND transaksi.outlet_id = $outlet_id 
    ...
    <div class="row">
      ...
      <div class="col-xs-6 col-md-4 col-lg-4 no-padding">
        <div class="panel panel-blue panel-widget border-right">
          <div class="row no-padding"><i class="fa fa-xl fa-users color-blue"></i>
      ...
      <div class="col-xs-6 col-md-4 col-lg-4 no-padding">
        <div class="panel panel-orange panel-widget border-right">
          <div class="row no-padding"><i class="fa fa-xl fa-shopping-cart color-red"></i>
    ...
    <div class="col-md-12">
      <div class="panel panel-container">
        <div style="padding: 0 30px 30px 30px;">
          <h3 style="padding: 0 0 20px 0;">10 Transaksi <strong><?= $nama_outlet['nama_outlet']; 
                  ?></strong> Terbaru</h3>
                ...
                <?php $no=1; foreach($data as $transaksi): ?>
                  <tr>
                    ...
                    <td align="center">
                      ...
                      title="Edit" 
                      class="btn btn-success btn-block disabled">Detail</a>
                    </td>
                  </tr>
